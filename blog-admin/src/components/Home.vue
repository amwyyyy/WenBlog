<template>
    <el-container>
        <el-aside>
            <h5 class="admin" :style="isCollapse ? 'text-align: center' : 'text-align: left;margin-left: 20px'">
                <span v-if="isCollapse">
                    <i class="fa fa-user fa-lg" aria-hidden="true" style="margin-right:5px;"></i>
                </span>
                <span v-else>
                    <i class="fa fa-user" aria-hidden="true" style="margin-right:5px;"></i>
                    您好!   <span style="color:#20a0ff;font-size:20px">{{ user.username }}</span>
                </span>
            </h5>
        ...
        <el-container style="width: 100px">
            <el-header>
                ...
                <el-col :span="3" style="text-align: right;">
                    <!--<el-badge is-dot hidden="true" style="vertical-align: top;">-->
